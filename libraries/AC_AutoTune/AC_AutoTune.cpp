...
void AC_AutoTune::control_attitude()
{
    ...
    case WAITING_FOR_LEVEL: {
        ...
        case ROLL:
            ...
            if (is_positive(attitude_control->get_ang_vel_roll_max())) {
                target_max_rate = MIN(attitude_control->get_ang_vel_roll_max(), target_max_rate);
            }
        ...
        case PITCH:
            target_max_rate = MAX(AUTOTUNE_TARGET_MIN_RATE_RLLPIT_CDS, step_scaler*AUTOTUNE_TARGET_RATE_RLLPIT_CDS);
            if (is_positive(attitude_control->get_ang_vel_pitch_max())) {
                target_max_rate = MIN(attitude_control->get_ang_vel_pitch_max(), target_max_rate);
            }
        ...
        case YAW:
            ...
            if (is_positive(attitude_control->get_ang_vel_yaw_max())) {
                target_max_rate = MIN(attitude_control->get_ang_vel_yaw_max(), target_max_rate);
            }
