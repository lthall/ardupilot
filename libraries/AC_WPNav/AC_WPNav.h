...
public:
    ...
    bool set_spline_destination_next_loc(const Location& next_destination, Location next_next_destination, bool next_next_is_spline);
...
protected:
    ...
    // spline curves
    spline_curve _spline_this_leg;      // spline curve for current segment
    spline_curve _spline_next_leg;      // spline curve for next segment
