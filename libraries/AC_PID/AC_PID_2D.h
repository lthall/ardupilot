...
public:
    ...
    Vector2f update_all(float target_x, float target_y, const Vector2f &measurement, bool limit = false);
    Vector2f update_all(float target_x, float target_y, const Vector3f &measurement, bool limit = false);
