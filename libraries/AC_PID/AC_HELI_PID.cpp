...
const AP_Param::GroupInfo AC_HELI_PID::var_info[] = {
    ...
    AP_GROUPINFO("FILT", 6, AC_HELI_PID, _filt_D_hz, AC_PID_FILT_HZ_DEFAULT),
...
/// Constructor for PID
AC_HELI_PID::AC_HELI_PID(float initial_p, float initial_i, float initial_d, float initial_imax, float initial_filt_T_hz, float initial_filt_E_hz, float initial_filt_D_hz, float dt, float initial_ff) :
    AC_PID(initial_p, initial_i, initial_d, initial_imax, initial_filt_T_hz, initial_filt_E_hz, initial_filt_D_hz, dt, initial_ff)
{
