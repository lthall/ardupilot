...
#define AC_PID_1D_FILT_E_HZ_DEFAULT 20.0f   // default input filter frequency
#define AC_PID_1D_FILT_E_HZ_MIN     0.01f   // minimum input filter frequency
...
const AP_Param::GroupInfo AC_PID_1D::var_info[] = {
    ...
    // @Units: Hz
    AP_GROUPINFO("FLTE", 3, AC_PID_1D, _filt_E_hz, AC_PID_1D_FILT_E_HZ_DEFAULT),
...
float AC_PID_1D::update_all(float target, float measurement, bool limit)
{
