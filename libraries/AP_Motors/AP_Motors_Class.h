...
public:
    ...
    void                set_roll_ff(float yaw_in) { _roll_in_ff = yaw_in; };    // range -1 ~ +1
    void                set_pitch(float pitch_in) { _pitch_in = pitch_in; };    // range -1 ~ +1
    void                set_pitch_ff(float yaw_in) { _pitch_in_ff = yaw_in; };  // range -1 ~ +1
...
protected:
    ...
    float               _yaw_in_ff;                 // desired yaw control from attitude controller, -1 ~ +1
