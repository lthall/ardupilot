...
public:
    ...
    float get_ang_vel_roll_max() const { return _ang_vel_roll_max; }

    // get the pitch angular velocity limit in radians/s
    float get_ang_vel_pitch_max() const { return _ang_vel_pitch_max; }

    // get the yaw angular velocity limit in radians/s
    float get_ang_vel_yaw_max() const { return _ang_vel_yaw_max; }
