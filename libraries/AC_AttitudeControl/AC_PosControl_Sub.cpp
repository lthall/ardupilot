...
void AC_PosControl_Sub::set_alt_target_from_climb_rate_ff(float climb_rate_cms, bool force_descend)
{
    ...
    _accel_last_z_cms += jerk_z * _dt;
    _accel_last_z_cms = MIN(accel_z_max, _accel_last_z_cms);

    float vel_change_limit = _accel_last_z_cms * _dt;
