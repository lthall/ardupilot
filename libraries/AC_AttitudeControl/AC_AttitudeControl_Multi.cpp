...
void AC_AttitudeControl_Multi::rate_controller_run()
{
    ...
    _motors.set_roll(rate_target_to_motor_roll(gyro_latest.x, _rate_target_ang_vel.x) + _actuator_sysid.x);
    _motors.set_pitch(rate_target_to_motor_pitch(gyro_latest.y, _rate_target_ang_vel.y) + _actuator_sysid.y);
    _motors.set_yaw(rate_target_to_motor_yaw(gyro_latest.z, _rate_target_ang_vel.z) + _actuator_sysid.z);
