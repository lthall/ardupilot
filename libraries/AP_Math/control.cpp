...
void update_vel_accel(Vector2f& vel, const Vector2f& accel, float dt,
    ...
    bool limit, Vector2f vel_error)
{
    ...
    update_vel_accel(vel_2f, accel_2f, dt, limit, vel_error);
    vel.x = vel_2f.x;
    vel.y = vel_2f.y;
}
...
void update_pos_vel_accel(Vector2f& pos, Vector2f& vel, const Vector2f& accel, float dt,
    ...
    bool limit, Vector2f pos_error, Vector2f vel_error)
{
    ...
    Vector2f vel_2f = Vector2f{vel.x, vel.y};
    Vector2f accel_2f = Vector2f{accel.x, accel.y};
    update_pos_vel_accel(pos_2f, vel_2f, accel_2f, dt,
