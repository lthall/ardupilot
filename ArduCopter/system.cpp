...
void Copter::update_dynamic_notch() {
    ...
    ins.update_harmonic_notch_freq_hz(attitude_control->get_notch_freq_scaled(ins.get_gyro_harmonic_notch_reference_freq_hz(), ins.get_gyro_harmonic_notch_reference()));
}
